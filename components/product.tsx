        ...
        <section className="h-32 md:h-48 w-full flex rounded-3xl overflow-hidden shadow-lg">
            ...
            <article className="p-4 flex-1 flex flex-col bg-gray-800">
                ...
                <div className="mt-auto">
                    ...
                    <Link href={`/product-detail/${product.id}`} className="w-fit ml-2 md:ml-4 p-1 md:p-2 inline-flex items-center text-sm font-medium bg-[#0ca7a590] rounded-lg shadow focus:bg-[#0ca7a5] hover:shadow-md hover:bg-[#0ca7a599] transition-all">
