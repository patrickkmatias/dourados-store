...
export default function NavBar() {
    ...
    return (
        <nav className={`p-4 max-w-screen-xl w-full fixed z-50 top-0 left-0 rounded-bl-3xl rounded-br-3xl border-b-4 border-b-dourados-golden flex justify-between bg-black shadow-xl translate-center-x ${loading ? 'loading-nav' : ''}`}>
